...
func verifyCommand() *cobra.Command {
	...
	command.Flags().StringSlice(cmd.PflagCertFile.Name, []string{}, "certificate files for verification")
...
func getVerifier(command *cobra.Command) (notation.Verifier, error) {
	certPaths, _ := command.Flags().GetStringSlice(cmd.PflagCertFile.Name)
